...
@section('content')
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h5 class="mt-2">Shift Kerja</h5>
                                    </div>
                                    <div class="col-lg-6">
                                        <a href="" class="btn btn-info float-right" data-target="#tambahPoint1"
                                            data-toggle="modal"><i class="fas fa-plus"></i> Tambah data</a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <table class="table " id="point1">
                                    ...
                                    <tbody>
                                        @foreach ($shift as $no => $k)
                                            <tr>
                                                <td>{{ $no + 1 }}</td>
                                                <td>{{ $k->ket }}</td>
                                                <td>{{ $k->waktu }} Jam</td>
                                                <td><a href="#" data-target="#edit1<?= $k->id_shift ?>"
                                                        data-toggle="modal" class="btn btn-warning btn-sm"><i
                                                            class="fas fa-edit"></i> </a>
                                                    <a onclick="rerutn confirm('Apakah yakin dihapus ?)"
                                                        href="{{ route('delete_shift', ['id_shift' => $k->id_shift]) }}"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($jumlahOrang as $k)
                                                    <tr>
                                                        ...
                                                        <td>{{ $k->jumlah }}</td>
                                                        <td><a href="#" data-target="#edit<?= $k->id_orang ?>"
                                                                data-toggle="modal" class="btn btn-warning btn-sm"><i
                                                                    class="fas fa-edit"></i> </a>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($persen as $p)
                                                    <tr>
                                                        ...
                                                        <td><a href="#"
                                                                data-target="#edit_persen<?= $p->id_persentase ?>"
                                                                data-toggle="modal" class="btn btn-warning btn-sm"><i
                                                                    class="fas fa-edit"></i> </a>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($menit as $p)
                                                    <tr>
                                                        ...
                                                        <td>{{ $p->nm_menit }}</td>
                                                        <td>{{ $p->menit }}</td>
                                                        <td><a href="#" data-target="#edit_menit<?= $p->id_menit ?>"
                                                                data-toggle="modal" class="btn btn-warning btn-sm"><i
                                                                    class="fas fa-edit"></i> </a>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" value="{{ $t->ket_karyawan }}"
                                    name="ket">
    ...
    <form action="{{ route('edit_persen') }}" method="post" accept-charset="utf-8">
        @csrf
        <div class="modal fade" id="edit_persen<?= $p->id_persentase ?>" role="dialog"
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" value="{{ $p->jumlah_persen }}"
                                    name="jumlah_persen">
    ...
    <form action="{{ route('insert_shift') }}" method="post" accept-charset="utf-8">
        @csrf
        <div class="modal fade" id="tambahPoint1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <input required type="number" name="point" value="{{ $t->point }}"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
    ...
    <form action="{{ route('tambah_ket') }}" method="post" accept-charset="utf-8">
        @csrf
        <div class="modal fade" id="tambahPoint2" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content ">
                    <div class="modal-header btn-costume">
